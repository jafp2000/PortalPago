...
<link href="{{ asset('public/assets/bxslider/jquery.bxslider.css')}}" rel="stylesheet"/>
<link rel="stylesheet" href="{{ asset('public/css/animate.css')}}">
<link rel="stylesheet" href="{{ asset('public/assets/owlcarousel/owl.carousel.css')}}">
<link rel="stylesheet" href="{{ asset('public/assets/owlcarousel/owl.theme.css')}}">

<link href="{{ asset('public/css/superfish.css')}}" rel="stylesheet" media="screen">
...
<link rel="stylesheet" type="text/css" href="{{ asset('public/css/parallax-slider/parallax-slider.css')}}"/>
<link rel="stylesheet" type="text/css" href="{{ asset('public/css/unslider/unslider.css')}}"/>
<link rel="stylesheet" type="text/css" href="{{ asset('public/css/unslider/unslider-dots.css')}}"/>
...
<script type="text/javascript" src="{{ asset('public/js/parallax-slider/modernizr.custom.28468.js')}}">
</script>

<!-- archivos para nuevo slider -->
<script src="{{ asset('public/js/plugins.js')}}"></script>
<script src="{{ asset('public/vendors/rs-plugin/js/jquery.themepunch.revolution.min.js')}}"></script>
<script src="{{ asset('public/js/pageview/revusliderpages.js')}}"></script>

<link href="{{ asset('public/vendors/rs-plugin/css/settings.css')}}" rel="stylesheet">
<link href="{{ asset('public/vendors/animation/animated.css')}}" rel="stylesheet">
<link href="{{ asset('public/vendors/animation/animate.min.css')}}" rel="stylesheet">
<link href="{{ asset('public/vendors/animation/animate.css')}}" rel="stylesheet">
...
<script type="text/javascript" src="{{ asset('public/js/validaciones/validation_cambiar_password.js')}}"></script>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid head-container">
                ...
                <a class="navbar-brand" href="{{asset('dashboard')}}">
                    <img class="img-responsive" src="{{ asset('public/images/logo_portaldepagos_verde.png')}}">
                </a>
                @else
    ...
    <div class="navbar navbar-default navbar-static-top container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{asset('/')}}"><img
                        src="{{ asset('public/images/logo_portaldepagos_verde.png')}}"></a>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-3 wow fadeInUp" data-wow-duration="2s" data-wow-delay=".3s">
                <p>Con el apoyo de</p>
                <img class="img-responsive center-block" src="{{ asset('public/images/sc_logo.png')}}">
            </div>
            ...
            <script type="text/javascript" src="{{ asset('public/js/hover-dropdown.js')}}"></script>
            <script defer src="{{ asset('public/js/jquery.flexslider.js')}}">
            </script>
            <script type="text/javascript" src="{{ asset('public/assets/bxslider/jquery.bxslider.js')}}">
            </script>

            <script type="text/javascript" src="{{ asset('public/js/jquery.parallax-1.1.3.js')}}">
            </script>
            <script src="{{ asset('public/js/wow.min.js')}}">
            </script>
            <script src="{{ asset('public/assets/owlcarousel/owl.carousel.js')}}">
            </script>

            <script src="{{ asset('public/js/jquery.easing.min.js')}}">
            </script>
            <script src="{{ asset('public/js/link-hover.js')}}">
            </script>
            <script src="{{ asset('public/js/superfish.js')}}">
            </script>
            <script src="{{ asset('public/js/parallax-slider/jquery.cslider.js')}}">
            </script>
            <script src="{{ asset('public/js/fileinput.min.js')}}">
            </script>
            <script src="{{ asset('public/js/locales/es.js')}}">
            </script>
